...
TCHAR szAppName[] = _T("EZTest");
TCHAR szTitle[] = _T("EZTest: Test of EZFONT");
...
void PaintRoutine(HWND hwnd, HDC hdc, int cxArea, int cyArea)
{
	...
	{
		hFont = EzCreateFont(hdc, _T("Times New Roman"), iPointSize, 0, 0, TRUE);
		GetObject(hFont, sizeof(LOGFONT), &lf);

		SelectObject(hdc, hFont);
		GetTextMetrics(hdc, &tm);
		TextOut(hdc, 0, y, szBuffer,
			_stprintf(szBuffer, _T("Times New Roman font of %i.%i points, lf.lfHeight = %i, tm.tmHeight = %i"),
