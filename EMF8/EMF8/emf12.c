...
TCHAR szAppName[] = _T("EMF12");
TCHAR szTitle[] = _T("EMF8: Enhanced Metafile Demo #12");
...
void CreateRoutine(HWND hwnd)
{
	...
	hdcEMF = CreateEnhMetaFile(NULL, _T("emf12.emf"), NULL, _T("EMF12\0EMF Demo #12\0"));
	if (NULL == hdcEMF)
	{
		return ;
	}
...
void PaintRoutine(HWND hwnd, HDC hdc, int cxArea, int cyArea)
{
	...
	hemf = GetEnhMetaFile(_T("emf12.emf"));
