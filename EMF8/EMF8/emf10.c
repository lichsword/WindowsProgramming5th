...
TCHAR szAppName[] = _T("EMF10");
TCHAR szTitle[] = _T("EMF8: Enhanced Metafile Demo #10");
...
void CreateRoutine(HWND hwnd)
{
	...
	hdcEMF = CreateEnhMetaFile(NULL, _T("emf8.emf"), NULL, _T("EMF8\0EMF Demo #8\0"));
	if (NULL == hdcEMF)
	{
		return ;
	}
...
void PaintRoutine(HWND hwnd, HDC hdc, int cxArea, int cyArea)
{
	...
	hemf = GetEnhMetaFile(_T("emf8.emf"));
